...
import { AnimationArrayType, SortingAlgorithmType } from "@/app/lib/types";
import {
  MAX_ANIMATION_SPEED,
...
export const SortingAlgorithmProvider = ({
  ...
  const runAnimation = (animations: AnimationArrayType, pseudocodeSteps: number[]) => {
    setIsSorting(true);
    ...
    animations.forEach((animation, index) => {
      setTimeout(() => {
        ...
        setHighlightedLine(pseudocodeSteps[index]); // Highlight pseudocode
        if (!isSwap) {
          updateClassList(
            lineIndexes,
            "change-line-color",
