    ...
    <div className="flex flex-col min-h-screen bg-black text-white">
      ...
      <main className="flex-1 flex items-center justify-center p-4 pt-20">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {/* Decorative elements */}
          <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-[#8B5DFF]/20 rounded-full filter blur-[120px]"></div>
          ...
          <Card className="w-full max-w-md border border-purple-900/30 bg-gradient-to-b from-gray-900/90 to-black/90 backdrop-blur-lg shadow-[0_0_25px_rgba(139,93,255,0.3)]">
            <CardHeader className="space-y-1 text-center">
              ...
              <CardTitle className="text-2xl font-bold tracking-tight">
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#b28fff] via-[#8B5DFF] to-[#7a4dff]">
                  Welcome back, Wizard
                </span>
              </CardTitle>
            ...
            <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      ...
                      className="text-xs text-[#8B5DFF] hover:text-[#9d6fff] transition-colors duration-200"
                    >
                      Forgot password?
                    </Link>
                  </div>
              ...
              <div className="relative flex items-center justify-center">
                ...
                <div className="relative px-3 bg-black text-sm text-gray-400">Or continue with</div>
              </div>
